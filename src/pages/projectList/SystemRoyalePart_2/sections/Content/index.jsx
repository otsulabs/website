    ...
    <section className={style.content}>
      <PageHeader
        title={
          isTablet ? (
            <>
              <Title.Row>System Royale - Part 2</Title.Row>
            </>
          ) : (
            <>
              <Title.Row>System Royale -</Title.Row>
              <Title.Row>Part 2</Title.Row>
            </>
          )
        }
        client={'Zokio by VoyceMe'}
        brief={
          'A second part of teaser trailer for System Royale by VoyceMe, the leading platform for English manga and webtoons.'
        }
        scope={
        ...
        video={isTablet ? [siteContent.projectsVideo.systemRPart_2] : []}
        videoThumbnail={isTablet ? siteContent.projectsPreview.systemRPart_2 : ''}
      />
      {
        isTablet ? <></> :
        <Gallery.Base
          ...
          big
          video
          videoThumbnail={siteContent.projectsPreview.systemRPart_2}
